...
public class RSAUtils {
    ...
    static {
        Map<String, String> appProperties = PropertisUtils.loadProperties("project.properties");
    ...
    public static String encryption(String content) {
        ...
        try {
            ...
            hexString = BytesHexUtils.bytesToHexString(encodedData);
        } catch (Exception e) {
            e.printStackTrace();
        }
     ...
     * @return 十六进制格式的加密数据
     */
    public static String encryption(String content, String privateKey) {
        String hexString = null;
        try {
            byte[] data = content.getBytes();
            byte[] encodedData = RSAUtils.encryptByPrivateKey(data, privateKey);
    ...
    public static void main(String[] args) {
        String preStr = "jdbc:mysql://127.0.0.1:3306/blogsys?allowMultiQueries=true&useUnicode=true&characterEncoding=utf8";
        // 加密
        String str = encryption(preStr, privateKey);

        // 解密
        str = "";
