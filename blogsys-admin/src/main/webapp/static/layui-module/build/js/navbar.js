        ...
        bind: function(callback, params) {
            ...
            $('.kit-side-fold').off('click').on('click', function() {
                ...
                if (_side.hasClass('kit-sided')) {
                    ...
                    $('#navigationIcon').removeClass('icon-shouqikuaijin');
                    $('#navigationIcon').addClass('icon-zhankaikuaitui');

                    $('.headPortrait').show(500);
                } else {// 隐藏
                    ...
                    $('#navigationIcon').removeClass('icon-zhankaikuaitui');
                    $('#navigationIcon').addClass('icon-shouqikuaijin');
                    $('.headPortrait').hide(500);
                }
            });
            return that;
        },
