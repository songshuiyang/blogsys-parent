...
<script>
    layui.use(['form', 'layer', 'upload'], function () {
        ...
        $(function () {
            $("#id").val("${leaving.id}");
            $("#author").val("${leaving.author}");
            $("#email").val("${leaving.email}");
            $("#authorLocationProvince").val("${leaving.authorLocationProvince}");
            $("#authorLocationCity").val("${leaving.authorLocationCity}");
            $("#satisfactoryNum").val("${leaving.satisfactoryNum}");
            $("#dissatisfiedNum").val("${leaving.dissatisfiedNum}");
            $("#content").val("${leaving.content}");
        });
