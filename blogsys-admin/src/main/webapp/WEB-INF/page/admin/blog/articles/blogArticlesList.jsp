...
<section class="container-module">
    ...
    <section class="functional-module">
        <div class="layui-btn-container">
            <shiro:hasPermission name="blog:blogArticles:add">
            ...
            <shiro:hasPermission name="blog:blogArticles:batchDelete">
            ...
            <shiro:hasPermission name="blog:blogArticles:batchRelease">
...
<script type="text/html" id="toolTemplete">
    <shiro:hasPermission name="blog:blogArrrticles:update">
        <a class="layui-btn layui-btn-radius layui-btn-xs layui-btn-warm" lay-event="edit"><i class="layui-icon">&#xe642;</i>编辑</a>
    </shiro:hasPermission>
    {{#  if(d.status == 0){ }}
    <shiro:hasPermission name="blog:blogArticles:release">
        <a class="layui-btn layui-btn-radius layui-btn-xs" lay-event="release"><i class="layui-icon">&#xe609;</i>发布</a>
    </shiro:hasPermission>
    {{#  } else { }}
    <shiro:hasPermission name="blog:blogArticles:unRelease">
        <a class="layui-btn layui-btn-radius layui-btn-xs layui-btn-primary" lay-event="notRelease"><i class="layui-icon">&#xe857;</i>不发布</a>
    </shiro:hasPermission>
    {{# } }}
        <a class="layui-btn layui-btn-radius layui-btn-xs layui-btn-normal" lay-event="detail"><i class="layui-icon">&#xe60b;</i>详情</a>
    {{#  if(d.enable == 1){ }}
    <shiro:hasPermission name="blog:blogArticles:delete">
    ...
    layui.use(['table','layer','form'], function(){
        ...
        table.render({
            ...
            cols: [[ //表头
                ...
                ,{field: 'title', title: '标题',width:"10%", sort: true, style: 'background-color: #00c0ef; color: #fff'}
