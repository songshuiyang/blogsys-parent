...
<section class="container-module">
    ...
    <section class="functional-module">
        <div class="layui-btn-container">
            ...
            <shiro:hasPermission name="blog:blogCategory:add">
            ...
            <shiro:hasPermission name="blog:blogCategory:BatchDelete">
    ...
    <section class="table-module">
        <table id="blogCategoryList" lay-filter="blogCategoryListTool"></table>
    </section>
</section>
...
<script type="text/html" id="toolTemplete">
    ...
    <shiro:hasPermission name="blog:blogCategory:edit">
    ...
    {{#  if(d.enable == 1){ }}
    <shiro:hasPermission name="blog:blogCategory:delete">
    ...
    layui.use(['table','layer','form'], function(){
        ...
        table.render({
            ...
            cols: [[ //表头
                ...
                ,{field: 'value', title: '分类',sort: true,style: 'background-color: #00c0ef; color: #fff'}
        ...
        // 监听工具条
        table.on('tool(blogCategoryListTool)', function(obj){ //注：tool是工具条事件名，test是table原始容器的属性 lay-filter="对应的值"
            ...
            if(layEvent === 'detail'){ //查看
                ...
                layer.confirm('确定要删除该【 ' + data.value + ' 】分类?', {icon: 3, title:'删除分类'}, function(index){
                    //do something
                    $.ajax({
                        url: "/blogCategory/" + data.id,
                        type: "delete",
                        success: function (msg) {
                            layer.msg('操作成功', {icon: 6});
                            layui.table.reload('blogCategoryList');
                        }
                    });
                    layer.close(index);
                });
        ...
        var active = {
            ...
            batchDelete: function () {
                var checkStatus = table.checkStatus('blogCategoryList')
                ...
                layer.confirm('确定要删除这【'+ data.length +'】条分类吗?', {icon: 3, title:'批量删除分类'}, function(index){
                    $.ajax({
                        url: "/blogCategory/batchDelete",
                        type: "post",
                        dataType:"json",
                        data: {ids: ids},
                        success: function (msg) {
